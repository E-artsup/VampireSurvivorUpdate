	...
	#endif
{
	...
	public void Awake()
	{
		UnityEngine.Debug.Log("Console Pro Remote Server is not supported on this platform");
	}
	...
	{
		UnityEngine.Debug.Log("Connected to " + peer.EndPoint);
		_ourPeer = peer;
	}

	public void OnPeerDisconnected(NetPeer peer, DisconnectInfo disconnectInfo)
	{
		UnityEngine.Debug.Log("Disconnected from " + peer.EndPoint + ", info: " + disconnectInfo.Reason);
		if (peer == _ourPeer)
		{
			_ourPeer = null;
		}
